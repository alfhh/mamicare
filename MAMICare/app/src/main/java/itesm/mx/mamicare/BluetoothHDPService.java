...
// */
//
//package itesm.mx.bluetoothhealth;
//
...
//                    mClient = null;
//                    Log.e(TAG, "unregister ui client");
//                    break;
//                // Register health application.
//                case MSG_REG_HEALTH_APP:
//                    registerApp(msg.arg1);
//                    Log.e(TAG, "register app");
//                    break;
//                // Unregister health application.
//                case MSG_UNREG_HEALTH_APP:
//                    unregisterApp();
//                    Log.e(TAG, "unregister app");
//                    break;
//                // Connect channel.
//                case MSG_CONNECT_CHANNEL:
//                    mDevice = (BluetoothDevice) msg.obj;
//                    connectChannel();
//                    Log.e(TAG, "connect channel");
//                    break;
//                // Disconnect channel.
//                case MSG_DISCONNECT_CHANNEL:
//                    mDevice = (BluetoothDevice) msg.obj;
//                    disconnectChannel();
//                    Log.e(TAG, "disconnect channel");
//                    break;
//                default:
//                    Log.e(TAG, "default service");
...
//                int channelId) {
//
//            Log.e(TAG, String.format("prevState\t%d ----------> newState\t%d",
//                    prevState, newState));
//            if (newState == BluetoothHealth.STATE_CHANNEL_CONNECTED) {
//                Log.e(TAG, "STATE_CHANNEL_CONNECTED");
//                (new ReadThread(fd)).start();
//            }
//            if (prevState == BluetoothHealth.STATE_CHANNEL_DISCONNECTED &&
//                    newState == BluetoothHealth.STATE_CHANNEL_CONNECTED) {
//                Log.e(TAG, "STATE_CHANNEL_DISCONNECTED && STATE_CHANNEL_CONNECTED");
//                if (config.equals(mHealthAppConfig)) {
//                    mChannelId = channelId;
//                    Log.e(TAG, " Se creo el socket ");
//                    sendMessage(STATUS_CREATE_CHANNEL, RESULT_OK);
//                    (new ReadThread(fd)).start();
//                } else {
//                    Log.e(TAG, " No se creo el socket ");
//                    sendMessage(STATUS_CREATE_CHANNEL, RESULT_FAIL);
//                }
//            } else if (prevState == BluetoothHealth.STATE_CHANNEL_CONNECTING &&
//                       newState == BluetoothHealth.STATE_CHANNEL_DISCONNECTED) {
//                Log.e(TAG, "STATE_CHANNEL_DISCONNECTED && STATE_CHANNEL_DISCONNECTED");
//                sendMessage(STATUS_CREATE_CHANNEL, RESULT_FAIL);
//            } else if (newState == BluetoothHealth.STATE_CHANNEL_DISCONNECTED) {
//                Log.e(TAG, "STATE_CHANNEL_DISCONNECTED");
//                if (config.equals(mHealthAppConfig)) {
