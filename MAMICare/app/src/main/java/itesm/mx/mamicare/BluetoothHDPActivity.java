...
//                    Log.e(TAG, " Se destruyo el socket ");
//                    break;
//                default:
//                    Log.e(TAG, "default activity");
...
//        String pf_OXIMETER = "oximeter";
//
//        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(this);
//        deviceId = sharedPref.getString(pf_OXIMETER, null);
...
//
//        if(mBluetoothAdapter != null) {
//            // Cycle bluetooth because it seems to get into a broken state.
...
//        {
//            intent = new Intent().setClass(this, BluetoothHDPService.class);
//
//            startService(intent);
